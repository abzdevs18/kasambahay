<?php require_once APP_ROOT . '/views/inc/header.php'; ?>
    ...
    <div class="container-fluid" style="margin: 0px;padding: 20px;background-color: #ffffff;">
        <div class="row">
            ...
            <div style="opacity:0;" class="col-8 text-center justify-content-center align-items-center align-content-center align-self-center" style="height: auto;padding-right: 0px;padding-left: 0px;">
