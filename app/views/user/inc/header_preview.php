...
<body data-gr-c-s-loaded="true" cz-shortcut-listen="true" class="mx-auto">
    ...
    <nav class="navigation">
        <div class="nav-group">
            <ul id="nav_">
                ...
                <li class="brackets">
                    <a class="m_side" data-navigation-target="chats" href="#" data-ui="Chat" title="" data-placement="right" data-original-title="Chats">
                        <!-- <span class="badge badge-warning"></span> -->
